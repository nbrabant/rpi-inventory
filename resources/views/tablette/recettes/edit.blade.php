...
<div id="admin-recette" class="col-md-12">
	...
	{!! Form::model($recette, array('class' => 'form-horizontal', 'url' => 'recettes/edit/'.$recette->id, 'files'=>true)) !!}
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::text('nombre_personnes', null, array('class' => 'form-control number-keyboard')) !!}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::text('temps_preparation', null, array('class' => 'form-control number-keyboard')) !!}
			</div>
		</div>
					...
					@foreach ($recette->produits as $produit)
						<li id="ingredient_{{ $produit->id }}" data-id="{{ $produit->produit_id }}">
							<div class="clearfix">
								...
								<input class="col-sm-2 number-keyboard" type="text" name="quantite_{{ $produit->produit_id }}" value="{{ $produit->quantite }}">
