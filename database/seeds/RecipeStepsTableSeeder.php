...
class RecipeStepsTableSeeder extends Seeder
{
    private $_datasToSeed = [
        [
            'recipe_id' => 1,
            'name' =>'étape 1',
            'instruction' => 'Cuire les pommes de terre dans de l&#39;eau bouillante pendant 15 minutes.',
            'position' => 1,
        ], [
            'recipe_id' => 1,
            'name' =>'étape 2',
            'instruction' => 'Dans un plat à four, disposer les filets de poulet, mettre un peu d&#39;huile d&#39;olive.Disposer tout autour les pommes de terre coupées en quartiers.Mettre l&#39;oignon, les gousses d&#39;ail et le maroilles sur les pommes de terre et les filets. Ajouter les herbes de Provence.',
            'position' => 2,
        ], [
            'recipe_id' => 1,
            'name' =>'étape 3',
            'instruction' => 'Enfourner à four préchauffé, à 200°C pendant 25 minutes.',
            'position' => 3,
        ], [
            'recipe_id' => 2,
            'name' =>'étape 1',
            'instruction' => 'Dans une terrine, mélangez le sucre et&nbsp;les oeufs. Ajouter la farine en mélangeant bien à la cuillère en bois ou au fouet et ajoutez l&#39;huile.',
            'position' => 1,
        ], [
            'recipe_id' => 2,
            'name' =>'étape 2',
            'instruction' => 'Délayez le mélange avec&nbsp;le lait tiède.Ajouter une pincée de sel et de la cannelle en poudre.',
            'position' => 2,
        ], [
            'recipe_id' => 2,
            'name' =>'étape 3',
            'instruction' => 'Dans un grand plat allant au four, copieusement beurré, disposez les cerises non dénoyautées.',
            'position' => 3,
        ], [
            'recipe_id' => 2,
            'name' =>'étape 4',
            'instruction' => 'Versez doucement la préparation sur les cerises.',
            'position' => 4,
        ], [
            'recipe_id' => 2,
            'name' =>'étape 5',
            'instruction' => 'Cuire au four à 180°C pendant 30 à 40 minutes.Dégustez tiède !',
            'position' => 5,
        ], [
            'recipe_id' => 3,
            'name' =>'étape 1',
            'instruction' => 'Emincer l&#39;oignon.<br />\r\nLe faire suer dans l&#39;huile.<br />\r\nAjouter ensuite l&#39;ail, la viande hachée, les sauces et laisser revenir 10 min.<br />\r\nRajouter le concentré de tomate, mouiller avec un peu d&#39;eau, couvrir et laisser mijoter 1 h.<br />\r\nEnviron 20 min avant la fin de la cuisson, cuire les p&acirc;tes al dente à l&#39;eau bouillante salée.<br />\r\nLes égoutter et les mélanger à la sauce dans la casserole.<br />\r\nSaupoudrer de parmesan et servir.',
            'position' => 1,
        ], [
            'recipe_id' => 4,
            'name' =>'étape 1',
            'instruction' => 'Eplucher les bananes. Les entourer ensuite d&#39;une tranche de jambon [comme des <a href="http://www.marmiton.org/magazine/diaporamiam_endives_1.aspx">endives</a>). Les mettre dans un plat (avec des bords). Etaler le gruyère r&acirc;pé sur le jambon et ajouter de la crème fra&icirc;che par dessus de fa&ccedil;on à ce que les bananes ne sèchent pas trop à la cuisson.<br />\r\nMettre au four à 200°C environ 30 mn.',
            'position' => 1,
        ], [
            'recipe_id' => 5,
            'name' =>'étape 1',
            'instruction' => 'Faire cuire le riz comme indiqué sur l&#39;emballage.<br />\r\nPendant ce temps fairechauffer la béchamel dans une casserole.<br />\r\nUne fois qu&#39;elle est arrivée à température, ajouter le thon égoutté et émietté.<br />\r\nDécouper les cornichons en petits morceaux et les ajouter (je met 3 cornichons moyens pour 1/2 litre de béchamel mais ceci est laissé à l&#39;appréciation de chacun).<br />\r\nEgoutter le riz puis mélanger la préparation &quot;béchamel-thon-cornichon&quot; au riz.<br />\r\nDéguster.',
            'position' => 1,
        ], [
            'recipe_id' => 5,
            'name' =>'étape 1',
